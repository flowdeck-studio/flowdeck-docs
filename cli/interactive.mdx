...
You can store your current configuration by selecting **Export Project Config** from the Project Commands menu (press `P`, then select **Export Project Config**). This allows you to use the configuration with CLI commands.
...
- [FlowDeck for AI Agents](/cli/ai-agents) - Why AI agents should use FlowDeck first
